...
namespace PaperClone.Utils
{
    public static class GeometryUtils
    {
        ...
        {
            // We ignore Y axis for 2D gameplay on XZ plane
            ...
            // Intersection must occur strictly between the points (0 < u < 1)
            // We use a small epsilon to avoid detecting "touching" (shared vertices) as overlap
